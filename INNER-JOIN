...
SELECT Orders.OrderID, Employees.FirstName, Employees.LastName, Orders.OrderDate FROM Orders 
...
SELECT Customers.CustomerName, Customers.City, Customers.Country, Suppliers.SupplierName FROM Customers
...
SELECT Orders.OrderID, Employees.FirstName, Employees.LastName, Orders.OrderDate, Shippers.ShipperName, Shippers.Phone FROM Orders 
INNER JOIN Employees ON Orders.EmployeeID = Employees.EmployeeID 
